...
<body>
	...
	<div class="popBg">
		<div class="popcon">
			<br>
			<p>
				<img src="./images/cloth_2.jpg" width="500px" height="400px">
			</p>
	...
	<div class="site-wrap">
		...
		<div class="site-blocks-cover"
			style="background-image: url(images/working.png);" data-aos="fade">
		</div>
											...
											<div class="item">
												<div class="block-4 text-center">
													<figure class="block-4-image">
														<img src="${ranklist.img1_path}" alt="Image placeholder"
															class="img-fluid">
													</figure>
													<div class="block-4-text p-4">
														<h3>
															<a href="#">${ranklist.pro_name}</a>
														</h3>
							...
							<div class="row align-items-center">
								...
								<div class="col-md-12 col-lg-5 text-center pl-md-5">
									...
									<p>Lorem ipsum dolor sit amet, consectetur adipisicing
										elit. Quisquam iste dolor accusantium facere corporis ipsum
										animi deleniti fugiat. Ex, veniam?</p>
									<p>
